...
export class Character extends Specable {
  ...
  private external_id = "";
  @hiddenProperty
  private set character_id(value: any) {
  ...
  @hiddenProperty
  private set character_visibility(value: CharacterVisibility) {
  ...
  @getterProperty
  public get imageGenerationEnabled() {
    return this.img_gen_enabled;
  }
  public set imageGenerationEnabled(value) {
    this.img_gen_enabled = value;
  }
  ...
  @getterProperty
  public get dynamicGreetingEnabled() {
    return this.dynamic_greeting_enabled ?? this.allow_dynamic_greeting;
  }
  ...
  @getterProperty
  public get baseImagePrompt() {
    return this.base_img_prompt;
  }
  public set baseImagePrompt(value) {
    this.base_img_prompt = value;
  }
  ...
  @getterProperty
  public get imagePromptRegex() {
    return this.img_prompt_regex;
  }
  public set imagePromptRegex(value) {
    this.img_prompt_regex = value;
  }
  ...
  @getterProperty
  public get stripImagePromptFromMessage() {
    return this.strip_img_prompt_from_msg;
  }
  public set stripImagePromptFromMessage(value) {
    this.strip_img_prompt_from_msg = value;
  }
  ...
  public set starterPrompts(value) {
    this.starter_prompts = value;
  }
  ...
  @getterProperty
  public get commentsEnabled() {
    return this.comments_enabled;
  }
  public set commentsEnabled(value) {
  ...
  private short_hash = "";
  @getterProperty
  public get shortHash() {
    return this.short_hash;
  }
  public set shortHash(value) {
    this.short_hash = value;
  }
  ...
  @getterProperty
  public get defaultVoiceId() {
    return this.default_voice_id;
  }
  public set defaultVoiceId(value) {
    this.default_voice_id = value;
  }
  ...
  public get displayName() {
    return (
      this.participant__name ??
      this.name ??
      this.participant__user__username ??
      this.character_name
    );
  }
  ...
  @getterProperty
  public get interactionCount() {
    return this.participant__num_interactions ?? this.num_interactions;
  }
  ...
  @getterProperty
  public get interactionCountLastDay() {
    return this.num_interactions_last_day;
  }
  ...
  private user__id = 0;
  @hiddenProperty
  private set creator_id(value: any) {
    this.user__id = value;
  }
  ...
  @hiddenProperty
  private set character_translations(value: any) {
  ...
  async getDMs(
    ...
    const request = await this.client.requester.request(
      `https://neo.character.ai/chats/?character_ids=${this.characterId}?num_preview_turns=${turnPreviewCount}`,
      {
        method: "GET",
  ...
  private async internalDM(
    ...
    var conversation;
    if (specificChatId) conversation = undefined; // fetchDMConversation removed
    ...
    if (!specificChatId)
      conversation = await this.client.fetchLatestDMConversationWith(
        this.characterId,
      );
  ...
  async createDM(withGreeting?: boolean) {
    return await this.internalDM(true, withGreeting);
  }
  async DM(specificChatId?: string) {
    return await this.internalDM(false, false, specificChatId);
  }

  async getAuthorProfile() {
    const username = this.user__username;
    const myProfile = this.client.myProfile;
    return username == myProfile.username ? myProfile : undefined;
  }
  ...
  async getVote() {
    ...
    const request = await this.client.requester.request(
      `https://plus.character.ai/chat/character/${this.characterId}/voted/`,
      {
        method: "GET",
        includeAuthorization: true,
      },
    ...
    switch (vote) {
      case true:
        return CharacterVote.Like;
      case false:
        return CharacterVote.Dislike;
    }
  ...
  async setVoiceOverride(voiceOrId: string) {
    let voiceId = voiceOrId;

    const request = await this.client.requester.request(
      `https://plus.character.ai/chat/character/${this.characterId}/voice_override/update/`,
      {
        method: "POST",
        includeAuthorization: true,
        contentType: "application/json",
  ...
  async getVoiceOverride(): Promise<string | undefined> {
    return undefined; // fetchSettings removed
  }

  // https://neo.character.ai/recommendation/v1/character/id
  async getSimilarCharacters() {
    return undefined;
  } // getSimilarCharactersTo removed

  async report(reason: string, additionalDetails = ""): Promise<string> {
    const request = await this.client.requester.request(
      `https://neo.character.ai/report/create`,
      {
        method: "POST",
  ...
  private async internalEdit(
    archived: boolean,
    options?: ICharacterModificationOptions,
  ) {
    this.client.checkAndThrow(CheckAndThrow.RequiresAuthentication);
    throw new Error("Not available");
  }
  async edit(options?: ICharacterModificationOptions) {
    return await this.internalEdit(false, options);
  }
  async delete() {
  ...
  // persona
  async setPersonaOverride(personaOrId: string) {
    throw new Error("Not available"); // setPersonaOverrideFor removed
  }
  async getPersonaOverride(): Promise<any | undefined> {
    return undefined; // getPersonaOverrideFor removed
  }
